  ...
  return (
    <div className=" mt-12 flex flex-col md:flex-row     justify-around p-5">
      <div className="w-[80%] md:w-[30%] mx-auto md:mx-0  flex items-center justify-center ">
        <div className=" w-[50%] md:w-[75%] h-[30%] md:h-[75%] rounded-lg shadow-lg border-4">
          <img
      ...
      <div className="flex flex-col mx-auto md:mx-0 justify-center gap-5 p-4 m-4 rounded-lg shadow-2xl shadow-gray-600 w-[100%] md:w-[60%]  bg-ferveritPink text-white pl-8 font-comfortaa">
